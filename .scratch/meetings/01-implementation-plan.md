...
## Sprint 5 — 听见式工作台 ✅（2026-09-08）

现行方案：[`docs/2026-09-08-meetings-studio.md`](../../docs/2026-09-08-meetings-studio.md)  
切片：[`.scratch/meetings-studio/01-plan.md`](../meetings-studio/01-plan.md)

| # | 任务 | 状态 |
|---|---|---|
| 5.1 | 列表点行进详情、左滑归档/恢复、右滑删除、地点/参会人 | ✅ |
| 5.2 | FAB / `/meetings/new` 建会后进详情并自动开录 | ✅ |
| 5.3 | 详情 70/30 工作台 + 麦克风 dock + 顶栏总结 | ✅ |
| 5.4 | 设置：标题/主题/地点/标签/总结技能 | ✅ |
| 5.5 | 待办分享转交 + 单条/整场 ACC | ✅ |
| 5.6 | 筛选举到顶栏 + 详情更多菜单 | ✅ |
