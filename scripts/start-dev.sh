...
export POCKET_AUTH_PASS="${POCKET_AUTH_PASS:-<SET_LOCALLY_MIN_8_CHARS>}"
...
echo ""
echo "测试命令:"
echo "  - 登录: curl -X POST http://localhost:8088/api/auth/login -H 'Content-Type: application/json' -d '{\"username\":\"\${POCKET_AUTH_USER:-admin}\",\"password\":\"\${POCKET_AUTH_PASS}\"}'"
