...
func TestHealthz(t *testing.T) {
	...
	srv := New(cfg, adapter.NewStaticNPSAdapter(), adapter.NewOpenCodeHTTPAdapter(timeoutMS), nil, reg, configAdapter, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, "", nil, nil)
...
func newTestServerWithAuth(t *testing.T) (*Server, string) {
	...
	reg := registry.NewRegistry()
	configAdapter := adapter.NewOpenCodeConfigHTTPAdapter(timeoutMS)
	srv := New(cfg, adapter.NewStaticNPSAdapter(), adapter.NewOpenCodeHTTPAdapter(timeoutMS), nil, reg, configAdapter, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, signer, nil, nil, nil, nil, "", nil, nil)
	return srv, token
}
